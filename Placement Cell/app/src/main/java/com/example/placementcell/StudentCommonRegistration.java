...
import com.example.placementcell.databinding.ActivityStudentCommonRegistrationBinding;
...
public class StudentCommonRegistration extends AppCompatActivity {
    ActivityStudentCommonRegistrationBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStudentCommonRegistrationBinding.inflate(getLayoutInflater());
        ...
        binding.dob.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(StudentCommonRegistration.this, date, myCalendar
