...
import com.example.placementcell.COMMON.GetResultView;
...
public class ViewResults extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_view_results2, container, false);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.SERVERUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    GetResultView adapter = new GetResultView(getActivity(), requestPojoList);
...
//                    nodata.setBackgroundResource(no_data_found);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("key", "getallresultstudent");
                map.put("getr_id", uid);
